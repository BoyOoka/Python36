...
*** Test Cases ***
login
    Open Application    http://127.0.0.1:4723/wd/hub    platformName=Android    platformVersion=8.1    deviceName=test    appPackge=com.bianla.tangba    app=D:/apk/tangba.apk
    ...    noReset=false
    ...
    input value    com.bianla.tangba:id/etPhone    13281549858
...
#    background app  0.1
    ...
    run keyword if    ${btnEnter}    input value      com.bianla.tangba:id/etPassword    123456
