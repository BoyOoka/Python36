...
#    driver.find_element_by_id("com.bianla.tangba:id/btnEnter").click()  # 点击“注册登陆”按钮
    visible_ele(driver, "id", "com.bianla.tangba:id/btnEnter").click() # 点击“注册登陆”按钮
    # driver.find_element_by_id("com.bianla.tangba:id/etPhone").send_keys(phone[i])  #输入账号 来自表格
    visible_ele(driver, "id", "com.bianla.tangba:id/etPhone").send_keys(phone[i]) #输入账号 来自表格
    # driver.find_element_by_id("com.bianla.tangba:id/btnNext").click()  #点击“下一步”
    visible_ele(driver, "id", "com.bianla.tangba:id/btnNext").click() #点击“下一步”
    # 正则匹配手机号
    if(len(phone[i])<11):
        print(len(phone[i]))
        ...
        visible_ele(driver, "id", "com.bianla.tangba:id/etPassword").send_keys(password[i]) #输入密码 来自表格
        # driver.find_element_by_id("com.bianla.tangba:id/btnEnter").click()  #点击“登陆”
        visible_ele(driver, "id", "com.bianla.tangba:id/btnEnter").click()  #点击“登陆”
        ...
        if (find_toast('用户名或密码错误')):
            ...
            visible_ele(driver, "id", "com.bianla.tangba:id/action_mine").click() #点击“我的”
            # driver.find_element_by_id("com.bianla.tangba:id/iv_add").click()  #点击右上角“设置”按钮
            visible_ele(driver, "id", "com.bianla.tangba:id/iv_add").click() #点击右上角“设置”按钮
            ...
            visible_ele(driver, "xpath", "//android.support.v7.widget.RecyclerView[@resource-id=\"com.bianla.tangba:id/recycler_view\"]/android.widget.RelativeLayout[4]").click()
            # driver.find_element_by_id("com.bianla.tangba:id/confirm").click()  #点击“确定退出”
            visible_ele(driver, "id", "com.bianla.tangba:id/confirm").click() #点击“确定退出”
       ...
       # driver.find_element_by_id("com.bianla.tangba:id/dialog_urine_ketone_iv_close").click()  # 点击“设置通知弹框”的关闭
        visible_ele(driver, "id", "com.bianla.tangba:id/etVCode").send_keys("1111")
        visible_ele(driver, "id", "com.bianla.tangba:id/etPassword").send_keys(password[i])
        visible_ele(driver, "id", "com.bianla.tangba:id/btnComplete").click()
        visible_ele(driver, "id", "com.bianla.tangba:id/btn_next").click()
        visible_ele(driver, "id", "com.bianla.tangba:id/btn_complete").click()
        ...
        # driver.find_element_by_xpath("//android.support.v7.widget.RecyclerView[@resource-id=\"com.bianla.tangba:id/recycler_view\"]/android.widget.RelativeLayout[4]").click()
        # driver.find_element_by_id("com.bianla.tangba:id/confirm").click()  #点击“确定退出”
        visible_ele(driver, "id", "com.bianla.tangba:id/action_mine").click()
        visible_ele(driver, "id", "com.bianla.tangba:id/iv_add").click()
        visible_ele(driver, "id", "//android.support.v7.widget.RecyclerView[@resource-id=\"com.bianla.tangba:id/recycler_view\"]/android.widget.RelativeLayout[4]").click()
        visible_ele(driver, "id", "com.bianla.tangba:id/confirm").click()
